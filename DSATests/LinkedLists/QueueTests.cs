...
namespace LinkedLists.Tests
{
    ...
    public class QueueTests
    {
        ...
        [Test]
        public void Enqueue_LengthIsZero_SetHeadAndTailToNodeAndIncrementLength()
        {
        ...
        [Test]
        public void Enqueue_LengthIsNotZero_SetTailNextAndTailToNewNodeAndIncrementLength()
        {
            queue.Enqueue("Yasser");
